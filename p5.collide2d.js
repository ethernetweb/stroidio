...
*/
console.log("### c2d.collide ###");
var c2d = function() {};

module.exports = new c2d();
c2d.prototype.dist = function(x1, y1, x2, y2) {
    var a = x1 - x2;
    var b = y1 - y2;
    return Math.sqrt( a*a + b*b );
}
c2d.prototype.sqrt = Math.sqrt;
c2d.prototype.pow = Math.pow;
c2d.prototype._collideDebug = false;

c2d.prototype.collideDebug = function(debugMode){
    _collideDebug = debugMode;
}

/*~++~+~+~++~+~++~++~+~+~ 2D ~+~+~++~+~++~+~+~+~+~+~+~+~+~+~+*/

c2d.prototype.collideRectRect = function (x, y, w, h, x2, y2, w2, h2) {
  //2d
...
c2d.prototype.collideRectCircle = function (rx, ry, rw, rh, cx, cy, diameter) {
  //2d
...
c2d.prototype.collideCircleCircle = function (x, y,d, x2, y2, d2) {
//2d
...
c2d.prototype.collidePointCircle = function (x, y, cx, cy, d) {
//2d
...
c2d.prototype.collidePointRect = function (pointX, pointY, x, y, xW, yW) {
//2d
...
c2d.prototype.collidePointLine = function(px,py,x1,y1,x2,y2, buffer){
...
c2d.prototype.collideLineCircle = function( x1,  y1,  x2,  y2,  cx,  cy,  diameter) {
...
c2d.prototype.collideLineLine = function(x1, y1, x2, y2, x3, y3, x4, y4,calcIntersection) {
...
c2d.prototype.collideLineRect = function(x1, y1, x2, y2, rx, ry, rw, rh, calcIntersection) {
...
c2d.prototype.collidePointPoly = function(px, py, vertices) {
  var collision = false;
...
// POLYGON/CIRCLE
c2d.prototype.collideCirclePoly = function(cx, cy, diameter, vertices, interior) {
...
c2d.prototype.collideRectPoly = function( rx, ry, rw, rh, vertices, interior) {
  if (interior == undefined){
    interior = false;
  }
...
c2d.prototype.collideLinePoly = function(x1, y1, x2, y2, vertices) {
...
c2d.prototype.collidePolyPoly = function(p1, p2, interior) {
  if (interior == undefined){
    interior = false;
  }
...
c2d.prototype.collidePointTriangle = function(px, py, x1, y1, x2, y2, x3, y3) {
...
c2d.prototype.collidePointPoint = function (x,y,x2,y2, buffer) {
    if(buffer == undefined){
      buffer = 0;
    }
...
c2d.prototype.collidePointArc = function(px, py, ax, ay, arcRadius, arcHeading, arcAngle, buffer) {
